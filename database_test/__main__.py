...
def main():
    ...
    if args.command == 'network':
        if args.j_flag:
            ...
            flaskr2.insert('network', json.dumps(network.get_network_info(), sort_keys=True, separators=(',', ': ')))
        elif args.s_flag:
            flaskr2.retrieve('network')
        else:
    ...
    if args.command == 'cpu':
        if args.j_flag:
            ...
            flaskr2.insert('cpu', json.dumps(cpu.mch_cpu(), sort_keys=True, separators=(',', ': ')))
        elif args.s_flag:
            flaskr2.retrieve('cpu')
        else:
    ...
    if args.command == 'ram':
        if args.j_flag:
            ...
            flaskr2.insert('ram', json.dumps(ram.get_ram_partitions(), sort_keys=True, separators=(',', ': ')))
        elif args.s_flag:
    ...
    if args.command == 'user':
        if args.j_flag:
            ...
            flaskr2.insert('user', json.dumps(user.get_users(), sort_keys=True, separators=(',', ': ')))
        elif args.s_flag:
            flaskr2.retrieve('user')
        else:
